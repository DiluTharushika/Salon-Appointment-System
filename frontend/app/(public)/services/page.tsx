      ...
      >
        ...
        <Container className="relative">
          <div className="mx-auto max-w-4xl text-center animate-fade-up">
            ...
            <div
              className="font-serif text-5xl sm:text-6xl md:text-7xl italic leading-[1.03]"
            ...
            >
              Explore our curated treatments and rituals, each crafted to restore
              your natural beauty and inner harmony.
            </p>
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-3 sm:gap-4">
              {["Hair", "Skin", "Nails", "Wellness"].map((cat) => (
                <button
                  key={cat}
                  className="rounded-full px-5 py-2.5 text-[10px] font-semibold uppercase tracking-[0.35em] transition-all duration-200 hover:-translate-y-0.5"
                  style={{
                    border: "1px solid rgba(201,169,110,0.28)",
                    background: "rgba(201,169,110,0.08)",
                    color: "rgba(232,213,168,0.90)",
      ...
      <Container className="py-14 sm:py-20">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <h2 className="mt-4 font-serif text-4xl sm:text-5xl" style={{ color: "var(--ink)" }}>
              {services.length > 0 ? (
                <>
                  <span style={{ color: "var(--rose)" }}>{services.length}</span>{" "}
                  Services Available
                </>
              ) : (
                "Our Collection"
          ...
          <div className="flex items-center gap-3">
            <div className="h-px w-14 sm:w-16" style={{ background: "rgba(201,169,110,0.30)" }} />
            <span
        ...
        {services.length === 0 ? (
          /* Empty state */
          <div className="glass-card rounded-3xl px-10 py-20 text-center space-y-6 animate-scale-in">
            <div
            ...
            <h3 className="font-serif text-3xl sm:text-4xl" style={{ color: "var(--ink)" }}>
              Coming Soon
            </h3>

            <p className="text-base max-w-sm mx-auto" style={{ color: "var(--muted)" }}>
              Our service menu is being beautifully curated. Please check back very soon.
            </p>

            <div className="divider-gold mx-auto" style={{ maxWidth: "90px" }} />
          ...
          <div className="grid gap-7 sm:gap-8 sm:grid-cols-2 animate-fade-up">
            {services.map((s) => (
              <ServiceCard
                key={s.id}
                name={s.name}
        ...
        <div className="mt-20">
          <div className="flex items-end justify-between gap-6 mb-8">
            <div>
              ...
              <h3 className="mt-4 font-serif text-3xl sm:text-4xl" style={{ color: "var(--ink)" }}>
                Explore by <span className="italic" style={{ color: "var(--rose)" }}>mood</span>
              </h3>
            </div>
            <div className="hidden sm:block divider-gold" style={{ maxWidth: "140px" }} />
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="gallery-overlay">
                  <span
                    className="text-[10px] uppercase tracking-[0.35em] font-semibold w-full text-center"
      ...
      <Container className="pb-24">
        ...
        >
          ...
          <div className="relative space-y-6">
            <div className="divider-gold mx-auto mb-6" style={{ maxWidth: "90px" }} />
            <p
            ...
            <h3 className="font-serif text-4xl sm:text-5xl md:text-6xl text-white">
